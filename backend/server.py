...
# Exercise demonstration videos - using MuscleWiki clean videos (no watermarks, looping MP4)
# These are professional exercise demonstrations
EXERCISE_MEDIA_BASE = "https://media.musclewiki.com/media/uploads/videos/branded/"

EXERCISE_GIFS = {
    # Chest exercises
    "bench press": f"{EXERCISE_MEDIA_BASE}male-barbell-bench-press-front.mp4",
    "barbell bench press": f"{EXERCISE_MEDIA_BASE}male-barbell-bench-press-front.mp4",
    "flat bench press": f"{EXERCISE_MEDIA_BASE}male-barbell-bench-press-front.mp4",
    "dumbbell bench press": f"{EXERCISE_MEDIA_BASE}male-dumbbell-bench-press-front.mp4",
    "dumbbell press": f"{EXERCISE_MEDIA_BASE}male-dumbbell-bench-press-front.mp4",
    "incline bench press": f"{EXERCISE_MEDIA_BASE}male-barbell-incline-bench-press-front.mp4",
    "incline dumbbell press": f"{EXERCISE_MEDIA_BASE}male-dumbbell-incline-bench-press-front.mp4",
    "decline bench press": f"{EXERCISE_MEDIA_BASE}male-barbell-decline-bench-press-front.mp4",
    "push-up": f"{EXERCISE_MEDIA_BASE}male-bodyweight-push-up-side.mp4",
    "push up": f"{EXERCISE_MEDIA_BASE}male-bodyweight-push-up-side.mp4",
    "pushup": f"{EXERCISE_MEDIA_BASE}male-bodyweight-push-up-side.mp4",
    "dumbbell fly": f"{EXERCISE_MEDIA_BASE}male-dumbbell-fly-front.mp4",
    "dumbbell flye": f"{EXERCISE_MEDIA_BASE}male-dumbbell-fly-front.mp4",
    "cable fly": f"{EXERCISE_MEDIA_BASE}male-cable-crossover-side.mp4",
    "cable crossover": f"{EXERCISE_MEDIA_BASE}male-cable-crossover-side.mp4",
    "chest dip": f"{EXERCISE_MEDIA_BASE}male-bodyweight-chest-dip-side.mp4",
    
    # Back exercises
    "pull-up": f"{EXERCISE_MEDIA_BASE}male-bodyweight-pull-up-front.mp4",
    "pull up": f"{EXERCISE_MEDIA_BASE}male-bodyweight-pull-up-front.mp4",
    "pullup": f"{EXERCISE_MEDIA_BASE}male-bodyweight-pull-up-front.mp4",
    "chin-up": f"{EXERCISE_MEDIA_BASE}male-bodyweight-chin-up-front.mp4",
    "chin up": f"{EXERCISE_MEDIA_BASE}male-bodyweight-chin-up-front.mp4",
    "lat pulldown": f"{EXERCISE_MEDIA_BASE}male-cable-lat-pulldown-front.mp4",
    "wide grip lat pulldown": f"{EXERCISE_MEDIA_BASE}male-cable-lat-pulldown-front.mp4",
    "barbell row": f"{EXERCISE_MEDIA_BASE}male-barbell-bent-over-row-side.mp4",
    "bent over row": f"{EXERCISE_MEDIA_BASE}male-barbell-bent-over-row-side.mp4",
    "barbell bent over row": f"{EXERCISE_MEDIA_BASE}male-barbell-bent-over-row-side.mp4",
    "dumbbell row": f"{EXERCISE_MEDIA_BASE}male-dumbbell-row-unilateral-side.mp4",
    "one arm dumbbell row": f"{EXERCISE_MEDIA_BASE}male-dumbbell-row-unilateral-side.mp4",
    "single arm row": f"{EXERCISE_MEDIA_BASE}male-dumbbell-row-unilateral-side.mp4",
    "seated cable row": f"{EXERCISE_MEDIA_BASE}male-cable-seated-row-side.mp4",
    "cable row": f"{EXERCISE_MEDIA_BASE}male-cable-seated-row-side.mp4",
    "deadlift": f"{EXERCISE_MEDIA_BASE}male-barbell-deadlift-front.mp4",
    "barbell deadlift": f"{EXERCISE_MEDIA_BASE}male-barbell-deadlift-front.mp4",
    "t-bar row": f"{EXERCISE_MEDIA_BASE}male-leverage-machine-t-bar-row-side.mp4",
    "t bar row": f"{EXERCISE_MEDIA_BASE}male-leverage-machine-t-bar-row-side.mp4",
    "face pull": f"{EXERCISE_MEDIA_BASE}male-cable-face-pull-side.mp4",
    
    # Shoulder exercises
    "shoulder press": f"{EXERCISE_MEDIA_BASE}male-dumbbell-shoulder-press-front.mp4",
    "dumbbell shoulder press": f"{EXERCISE_MEDIA_BASE}male-dumbbell-shoulder-press-front.mp4",
    "overhead press": f"{EXERCISE_MEDIA_BASE}male-barbell-overhead-press-front.mp4",
    "military press": f"{EXERCISE_MEDIA_BASE}male-barbell-overhead-press-front.mp4",
    "barbell shoulder press": f"{EXERCISE_MEDIA_BASE}male-barbell-overhead-press-front.mp4",
    "arnold press": f"{EXERCISE_MEDIA_BASE}male-dumbbell-arnold-press-front.mp4",
    "lateral raise": f"{EXERCISE_MEDIA_BASE}male-dumbbell-lateral-raise-front.mp4",
    "dumbbell lateral raise": f"{EXERCISE_MEDIA_BASE}male-dumbbell-lateral-raise-front.mp4",
    "side lateral raise": f"{EXERCISE_MEDIA_BASE}male-dumbbell-lateral-raise-front.mp4",
    "front raise": f"{EXERCISE_MEDIA_BASE}male-dumbbell-front-raise-side.mp4",
    "dumbbell front raise": f"{EXERCISE_MEDIA_BASE}male-dumbbell-front-raise-side.mp4",
    "rear delt fly": f"{EXERCISE_MEDIA_BASE}male-dumbbell-rear-delt-fly-side.mp4",
    "reverse fly": f"{EXERCISE_MEDIA_BASE}male-dumbbell-rear-delt-fly-side.mp4",
    "upright row": f"{EXERCISE_MEDIA_BASE}male-barbell-upright-row-front.mp4",
    "barbell upright row": f"{EXERCISE_MEDIA_BASE}male-barbell-upright-row-front.mp4",
    "shrug": f"{EXERCISE_MEDIA_BASE}male-barbell-shrug-front.mp4",
    "dumbbell shrug": f"{EXERCISE_MEDIA_BASE}male-dumbbell-shrug-front.mp4",
    
    # Arm exercises - Biceps
    "bicep curl": f"{EXERCISE_MEDIA_BASE}male-dumbbell-bicep-curl-front.mp4",
    "dumbbell curl": f"{EXERCISE_MEDIA_BASE}male-dumbbell-bicep-curl-front.mp4",
    "dumbbell bicep curl": f"{EXERCISE_MEDIA_BASE}male-dumbbell-bicep-curl-front.mp4",
    "barbell curl": f"{EXERCISE_MEDIA_BASE}male-barbell-curl-front.mp4",
    "hammer curl": f"{EXERCISE_MEDIA_BASE}male-dumbbell-hammer-curl-front.mp4",
    "dumbbell hammer curl": f"{EXERCISE_MEDIA_BASE}male-dumbbell-hammer-curl-front.mp4",
    "preacher curl": f"{EXERCISE_MEDIA_BASE}male-dumbbell-preacher-curl-side.mp4",
    "concentration curl": f"{EXERCISE_MEDIA_BASE}male-dumbbell-concentration-curl-front.mp4",
    "cable curl": f"{EXERCISE_MEDIA_BASE}male-cable-curl-front.mp4",
    "incline dumbbell curl": f"{EXERCISE_MEDIA_BASE}male-dumbbell-incline-curl-side.mp4",
    
    # Arm exercises - Triceps
    "tricep pushdown": f"{EXERCISE_MEDIA_BASE}male-cable-pushdown-side.mp4",
    "tricep extension": f"{EXERCISE_MEDIA_BASE}male-dumbbell-tricep-extension-front.mp4",
    "overhead tricep extension": f"{EXERCISE_MEDIA_BASE}male-dumbbell-tricep-extension-front.mp4",
    "dumbbell tricep extension": f"{EXERCISE_MEDIA_BASE}male-dumbbell-tricep-extension-front.mp4",
    "skull crusher": f"{EXERCISE_MEDIA_BASE}male-barbell-skull-crusher-side.mp4",
    "lying tricep extension": f"{EXERCISE_MEDIA_BASE}male-barbell-skull-crusher-side.mp4",
    "tricep dip": f"{EXERCISE_MEDIA_BASE}male-bodyweight-tricep-dip-side.mp4",
    "dip": f"{EXERCISE_MEDIA_BASE}male-bodyweight-tricep-dip-side.mp4",
    "bench dip": f"{EXERCISE_MEDIA_BASE}male-bodyweight-bench-dip-side.mp4",
    "close grip bench press": f"{EXERCISE_MEDIA_BASE}male-barbell-close-grip-bench-press-front.mp4",
    "tricep kickback": f"{EXERCISE_MEDIA_BASE}male-dumbbell-kickback-side.mp4",
    "rope pushdown": f"{EXERCISE_MEDIA_BASE}male-cable-rope-pushdown-side.mp4",
    
    # Leg exercises
    "squat": f"{EXERCISE_MEDIA_BASE}male-barbell-squat-front.mp4",
    "barbell squat": f"{EXERCISE_MEDIA_BASE}male-barbell-squat-front.mp4",
    "back squat": f"{EXERCISE_MEDIA_BASE}male-barbell-squat-front.mp4",
    "front squat": f"{EXERCISE_MEDIA_BASE}male-barbell-front-squat-side.mp4",
    "goblet squat": f"{EXERCISE_MEDIA_BASE}male-dumbbell-goblet-squat-front.mp4",
    "dumbbell squat": f"{EXERCISE_MEDIA_BASE}male-dumbbell-goblet-squat-front.mp4",
    "leg press": f"{EXERCISE_MEDIA_BASE}male-lever-leg-press-side.mp4",
    "lunge": f"{EXERCISE_MEDIA_BASE}male-dumbbell-lunge-front.mp4",
    "dumbbell lunge": f"{EXERCISE_MEDIA_BASE}male-dumbbell-lunge-front.mp4",
    "walking lunge": f"{EXERCISE_MEDIA_BASE}male-dumbbell-walking-lunge-front.mp4",
    "bulgarian split squat": f"{EXERCISE_MEDIA_BASE}male-dumbbell-bulgarian-split-squat-front.mp4",
    "split squat": f"{EXERCISE_MEDIA_BASE}male-dumbbell-bulgarian-split-squat-front.mp4",
    "leg curl": f"{EXERCISE_MEDIA_BASE}male-lever-lying-leg-curl-side.mp4",
    "lying leg curl": f"{EXERCISE_MEDIA_BASE}male-lever-lying-leg-curl-side.mp4",
    "hamstring curl": f"{EXERCISE_MEDIA_BASE}male-lever-lying-leg-curl-side.mp4",
    "leg extension": f"{EXERCISE_MEDIA_BASE}male-lever-leg-extension-side.mp4",
    "calf raise": f"{EXERCISE_MEDIA_BASE}male-bodyweight-standing-calf-raise-side.mp4",
    "standing calf raise": f"{EXERCISE_MEDIA_BASE}male-bodyweight-standing-calf-raise-side.mp4",
    "seated calf raise": f"{EXERCISE_MEDIA_BASE}male-lever-seated-calf-raise-side.mp4",
    "romanian deadlift": f"{EXERCISE_MEDIA_BASE}male-barbell-romanian-deadlift-side.mp4",
    "stiff leg deadlift": f"{EXERCISE_MEDIA_BASE}male-barbell-stiff-leg-deadlift-side.mp4",
    "hip thrust": f"{EXERCISE_MEDIA_BASE}male-barbell-hip-thrust-side.mp4",
    "barbell hip thrust": f"{EXERCISE_MEDIA_BASE}male-barbell-hip-thrust-side.mp4",
    "glute bridge": f"{EXERCISE_MEDIA_BASE}male-bodyweight-glute-bridge-side.mp4",
    "step up": f"{EXERCISE_MEDIA_BASE}male-dumbbell-step-up-side.mp4",
    "hack squat": f"{EXERCISE_MEDIA_BASE}male-lever-hack-squat-side.mp4",
    "sumo deadlift": f"{EXERCISE_MEDIA_BASE}male-barbell-sumo-deadlift-front.mp4",
    
    # Core exercises
    "plank": f"{EXERCISE_MEDIA_BASE}male-bodyweight-front-plank-side.mp4",
    "crunch": f"{EXERCISE_MEDIA_BASE}male-bodyweight-crunch-side.mp4",
    "sit-up": f"{EXERCISE_MEDIA_BASE}male-bodyweight-sit-up-side.mp4",
    "sit up": f"{EXERCISE_MEDIA_BASE}male-bodyweight-sit-up-side.mp4",
    "russian twist": f"{EXERCISE_MEDIA_BASE}male-bodyweight-russian-twist-front.mp4",
    "leg raise": f"{EXERCISE_MEDIA_BASE}male-bodyweight-lying-leg-raise-side.mp4",
    "lying leg raise": f"{EXERCISE_MEDIA_BASE}male-bodyweight-lying-leg-raise-side.mp4",
    "hanging leg raise": f"{EXERCISE_MEDIA_BASE}male-bodyweight-hanging-leg-raise-front.mp4",
    "mountain climber": f"{EXERCISE_MEDIA_BASE}male-bodyweight-mountain-climber-side.mp4",
    "bicycle crunch": f"{EXERCISE_MEDIA_BASE}male-bodyweight-bicycle-crunch-side.mp4",
    "ab wheel rollout": f"{EXERCISE_MEDIA_BASE}male-wheel-rollout-side.mp4",
    "reverse crunch": f"{EXERCISE_MEDIA_BASE}male-bodyweight-reverse-crunch-side.mp4",
    "cable crunch": f"{EXERCISE_MEDIA_BASE}male-cable-crunch-side.mp4",
    "side plank": f"{EXERCISE_MEDIA_BASE}male-bodyweight-side-plank-front.mp4",
    "dead bug": f"{EXERCISE_MEDIA_BASE}male-bodyweight-dead-bug-side.mp4",
    
    # Full body / Compound
    "burpee": f"{EXERCISE_MEDIA_BASE}male-bodyweight-burpee-side.mp4",
    "clean and press": f"{EXERCISE_MEDIA_BASE}male-barbell-clean-and-press-side.mp4",
    "kettlebell swing": f"{EXERCISE_MEDIA_BASE}male-kettlebell-swing-side.mp4",
    "thruster": f"{EXERCISE_MEDIA_BASE}male-barbell-thruster-front.mp4",
}

def get_exercise_gif(exercise_name: str) -> str:
    """Get video/media URL for an exercise by name matching"""
    ...
    # Return a default exercise video if no match
    return f"{EXERCISE_MEDIA_BASE}male-dumbbell-bicep-curl-front.mp4"
